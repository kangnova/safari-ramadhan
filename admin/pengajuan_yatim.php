...
// Query untuk data statistik khusus yatim
$queryStatistik = "
    SELECT 
        COUNT(DISTINCT id) as total_lembaga_yatim,
        SUM(jumlah_santri) as total_santri,
        COUNT(id) as total_pengajuan_yatim,
        COUNT(CASE WHEN status = 'approved' THEN 1 END) as total_approved
    FROM ifthar 
    WHERE santri_yatim IS NOT NULL AND santri_yatim != ''";

$stmtStats = $conn->prepare($queryStatistik);
$stmtStats->execute();
$stats = $stmtStats->fetch(PDO::FETCH_ASSOC);

// Query untuk data pendaftar yang memiliki santri yatim
$query = "SELECT * FROM ifthar WHERE santri_yatim IS NOT NULL AND santri_yatim != '' ORDER BY created_at DESC";
...
<head>
    ...
    <title>Data Pengajuan Santri Yatim - Ifthar 1000 Santri</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid mt-4 px-4">
        <h2 class="text-center mb-4">Dashboard Pengajuan Santri Yatim</h2>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stats-card h-100 bg-primary text-white">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Total Lembaga Yatim</h5>
                        <h2 class="mb-0"><?= $stats['total_lembaga_yatim'] ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card stats-card h-100 bg-success text-white">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Total Yatim</h5>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stats-card h-100 bg-info text-white">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Total Santri Yatim</h5>
        ...
        <div class="card">
            <div class="card-header bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Data Pengajuan Santri Yatim</h5>
                    <div>
                        <a href="export-yatim.php" class="btn btn-success btn-sm">
                    ...
                    <table id="pendaftarTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($pendaftar as $index => $data): 
                                // Hitung jumlah yatim dari text input
                                $jumlah_yatim = is_numeric($data['santri_yatim']) ? 
                                    $data['santri_yatim'] : 
                                    substr_count(strtolower($data['santri_yatim']), "\n") + 1;
                            ?>
                            <tr>
                                <td><?= $index + 1 ?></td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Detail Pengajuan Yatim - <?= htmlspecialchars($data['asal_lembaga']) ?></h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-primary">Data Santri Yatim</h6>
                            <div class="border rounded p-2">
                                <?= nl2br(htmlspecialchars($data['santri_yatim'])) ?>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
