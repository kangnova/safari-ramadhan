        ...
        <div class="p-4">
                ...
                <form id="paymentForm" method="POST">
                    ...
                    <div class="payment-group">
                        ...
                        <div class="payment-option <?php echo $selected_payment == 'bsi' ? 'selected' : ''; ?>" 
                            ...
                            <div class="payment-option-description">💳 BSI 2 : 9191919235</div>
                        </div>
                        ...
                        <div class="payment-option <?php echo $selected_payment == 'jateng' ? 'selected' : ''; ?>" 
                             onclick="selectPaymentMethod('jateng', this)">
                            <div class="payment-option-title">BANK JATENG</div>
                            <div class="payment-option-description">💳 BANK JATENG : 2138041240</div>
                        </div>
                    </div>
            ...
            <div class="payment-details" id="bsiPaymentDetails">
                ...
                <div class="detail-section mt-4">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-2"><strong>9191919235</strong></div>
                        <button class="copy-button" onclick="copyToClipboard('9191919235')">Salin Nomor Rekening</button>
                    </div>
                </div>
                ...
                <div class="upload-section">
                    ...
                    <div class="mt-3 text-center">
                        <p>Atau jika Anda ingin mengunggah bukti di lain waktu:</p>
                        <a href="upload_bukti_kemudian.php?token=<?php echo $donasi['token']; ?>" class="btn btn-outline-secondary w-100">
            ...
            <div class="payment-details" id="mandiriPaymentDetails">
                <h4 class="mb-4">MANDIRI</h4>
                <h5>Transfer Manual</h5>
                
                <div class="detail-section mt-4">
                    <div class="detail-title">Nomor Rekening</div>
                    <div class="d-flex align-items-center">
                        <div class="me-2"><strong>1380015275477</strong></div>
                        <button class="copy-button" onclick="copyToClipboard('1380015275477')">Salin Nomor Rekening</button>
                    </div>
                </div>
            ...
            <div class="payment-details" id="jatengPaymentDetails">
                <h4 class="mb-4">BANK JATENG</h4>
                <h5>Transfer Manual</h5>
                
                <div class="detail-section mt-4">
                    <div class="detail-title">Nomor Rekening</div>
                    <div class="d-flex align-items-center">
                        <div class="me-2"><strong>2138041240</strong></div>
                        <button class="copy-button" onclick="copyToClipboard('2138041240')">Salin Nomor Rekening</button>
                    </div>
                </div>
            ...
            <div class="payment-details" id="qrisPaymentDetails">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-3">
                        <a href="img/qris" download="qris.jpg" class="btn btn-outline-primary btn-sm">Download QRIS</a>
                    </div>
                </div>
                ...
                <!-- Tambahkan opsi untuk upload nanti pada QRIS -->
                <div class="upload-section">
                    <div class="detail-title mb-3">Konfirmasi Pembayaran QRIS</div>
                    <p>Setelah melakukan pembayaran melalui QRIS, Anda dapat mengupload bukti pembayaran:</p>
                    <form method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <input type="file" class="form-control" name="bukti_transfer" accept="image/jpeg,image/png,application/pdf" required>
                        </div>
                        <button type="submit" name="submit_bukti" class="btn btn-primary w-100">Upload Bukti Pembayaran</button>
                    </form>
                    <div class="mt-3 text-center">
                        <p>Atau jika Anda ingin mengunggah bukti di lain waktu:</p>
                        <a href="upload_bukti_kemudian.php?token=<?php echo $donasi['token']; ?>" class="btn btn-outline-secondary w-100">
                            Upload Bukti Pembayaran Nanti
                        </a>
                    </div>
                </div>
